...
///fix the victory ui where shows the coin gathered and the ones missing.
///make it so you can "ride" a plataform
//improve the stage 6. just make it more interesting
//improve the stage 7. change that tunnel part.
///improve the gate presentation and graphic
///improve the tutorial graphic
///make it clear that you can go through plataform by holding the down button
///finish teh char purchase system


//BUG
//in stage 3 it is showing 7/5 of coins fouhnd.
///jump effects are taking too long to destroy and are playing in the middle of nowhere.
//stage 9 jumper is not working
//stage 11 cecilling has no collider
//the player is immune without actually being immune?
///possible problem wiht getting stufck intside the plataform ccollider.
//for some reason in stage 3 the playerhandler was destroyed.
//for some reason certain eggs dont work.

//STAGE 3
//there is a weird blocck in the mmiddle of the air.
//
...
//add pig sound (teste)
//add bat sound (teste)
//add spike sound (teste)
//add chamelleon sound (teste)
//add bee sound
//when not using the buttons fade into to the battleground
//fix the stages


//PROBKLEMS TO FIX
///pig walking sound in the main menu animation
///bees are shooting without cooldown
///bees have no sound still
///the bat sound is delayed
///make the bee attack in a better frequency
///in stage 7 the bats are not detecting the player
//fix the thing where the player stays in the air whilve moving forward and colliding.
///the player is not being changed back to player layer.
///create a sound for gate opening
///chamelleon put 3d sound
///create loading sccren
///redo the stage 13.
//improvements in stage 15