...
public class PlayerMove : MonoBehaviour
{
    ...
    [SerializeField] float clampedFallSpeed;
    ...
    private void Update()
    {
        ...
        clampedFall = Mathf.Clamp(clampedFall, -clampedFallSpeed, 50);

        handler.rb.velocity = new Vector2(handler.rb.velocity.x, clampedFall);
    ...
    public void PressJump(bool cannotForceJump = false)
    {
        ...
        if (!isGrounded && currentDoubleJumps < totalDoubleJump)
        {
            ...
            Jump(jumpForce);
            GameHandler.instance.sound.CreateSFX(handler.jumpSFX, transform);
        ...
        if(handler.jumpSFX != null && GameHandler.instance != null) GameHandler.instance.sound.CreateSFX(handler.jumpSFX, transform);
    ...
    void SpawnPSJump()
    {
        ...
        newObject.gameObject.GetComponent<DestroySelf>().SetUp(newObject.main.duration);
    }
