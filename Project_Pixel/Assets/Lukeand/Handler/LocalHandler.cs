...
public class LocalHandler : MonoBehaviour
{
    ...
    public void InitScene()
    {
        ...
        UIHolder.instance.victory.UpdateCoin(localGoldGained, stageData.howManyCoinInScene);
        UIHolder.instance.pause.Force(false);

        handler.gameObject.layer = 3;
    ...
    public void AddLocalGold(int index)
    {
        ...
        UIHolder.instance.victory.UpdateCoin(localGoldStored + localGoldGained, stageData.howManyCoinInScene);
    }
